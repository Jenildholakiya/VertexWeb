    ...
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden pt-24 will-change-[contents]">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          {/* Responsive Typography: Scaled perfectly for Tablet (text-7xl) vs Desktop (md:text-[9rem]) */}
      ...
      {/* Optimized Floating Meta-Info for Tablet */}
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 h-10 w-px bg-white/10">
        <motion.div animate={{ y: [-40, 40] }} transition={{ repeat: Infinity, duration: 2.5, ease: "linear" }} className="h-full w-full bg-primary" />
      </div>
    </section>
  );
};